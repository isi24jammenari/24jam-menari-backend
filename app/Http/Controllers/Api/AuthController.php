...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // DETEKSI DIREVISI: Tambahkan deteksi untuk kata 'tenant'
        $isAdminDomain = str_contains($origin, 'admin.') 
            || str_contains($referer, 'admin.') 
            || str_contains($origin, 'komunitas') 
            || str_contains($referer, 'komunitas')
            || str_contains($origin, 'tenant') // <-- IZINKAN AKSES DARI SUBDOMAIN TENANT
            || str_contains($referer, 'tenant'); // <-- IZINKAN AKSES DARI SUBDOMAIN TENANT
